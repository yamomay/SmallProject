...
function discount(){
	popWin = window.open("../purchase/discount.jsp","popWin",'width=600,height=500,location=no,status=no,scrollbars=no');
}
-->
...
<form name="addPurchase" method="post" action="/addPurchase.do?ProdNo=${pvo.purchaseProd.prodNo}">
