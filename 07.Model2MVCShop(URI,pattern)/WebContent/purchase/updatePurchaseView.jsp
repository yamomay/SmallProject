...
<form name="updatePurchase" method="post"	action="/purchase/updatePurchase?tranNo=${pvo4.tranNo}">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			...
			height: 19px" maxLength="20" value="${pvo4.receiverName}"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			class="ct_input_g" style="width: 100px; 
			height: 19px" maxLength="20" value="${pvo4.receiverPhone}" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="divyAddr" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="${pvo4.divyAddr}" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			class="ct_input_g" style="width: 100px; 
			height: 19px" maxLength="20" value="${pvo4.divyRequest}" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
