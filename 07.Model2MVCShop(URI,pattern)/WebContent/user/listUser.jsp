...
<!--
	...
	function coupon(){
		location.href='/user/listUser?coupon=yes&userId=${user.userId}&userName=${user.userName}&currentPage=${resultPage.currentPage}';
	}
	-->
</script>
<%
System.out.println("couponUrl : "+request.getParameter("couponUrl"));
System.out.println("couponNo : "+request.getParameter("couponNo"));
System.out.println("Id : "+request.getParameter("userId"));
%>
</head>

<body bgcolor="#ffffff" text="#000000">
	<c:if test="${couponNo=='yes'}">
		<script>
			window.open( ${couponUrl} , 'popWin',
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<c:forEach var="user" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td></td>
						<td align="center"><input type="button" name="name"
							value="쿠폰발급"
							onclick="location.href='/user/listUser?coupon=yes&userId=${user.userId}&currentPage=${resultPage.currentPage}&userName=${user.userName}'">
						</td>
					</tr>
					<tr>
