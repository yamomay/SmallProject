...
<jsp:include page="../common/cookie.jsp">
	<jsp:param value="${provo.prodNo}" name="prodNo"/>
</jsp:include>
...
<form name="detailForm" method="post" action="/purchase/addPurchaseView?prod_no=${provo.prodNo}">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	<tr>
		...
		<c:if test="${ param.menu == 'search' or param.menu == 'manage'}">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<c:if test="${provo.proTranCode.trim() == 0 and ! empty user}">
					<td width="17" height="23">
						<img src="/images/ct_btnbg01.gif" width="17" height="23"/>
					</td>
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
