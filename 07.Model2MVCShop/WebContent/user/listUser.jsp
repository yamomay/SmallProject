...
<!--
	...
	function coupon(){
		location.href='/listUser.do?coupon=yes&userId=${user.userId}&userName=${user.userName}&currentPage=${resultPage.currentPage}';
	}
	-->
</script>
<%
				...
				<c:forEach var="user" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td align="center"><input type="button" name="name"
							value="쿠폰발급"
							onclick="location.href='/listUser.do?coupon=yes&userId=${user.userId}&currentPage=${resultPage.currentPage}&userName=${user.userName}'">
						</td>
					</tr>
					<tr>
